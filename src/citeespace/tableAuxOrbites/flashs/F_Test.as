package citeespace.tableAuxOrbites.flashs
{
	 ...
	 * @author GUYF
	 */	
	public dynamic class F_Test extends F_Anim_super
		{
			...
			protected function _loadUiParts(event:Event=null):void
			{
				...
				*/
				...
				loader = new Loader();
				loader.load(new URLRequest('../swf/user_test.swf'));
			...
			protected function _checkLoadQueue(loadedToken:String=''):void
			{
				...
				GameLogicEvent.dispatch(GameLogicEvent.IDENTIFIER_SIGNAL_SHOW);
				*/
			...
			private function keep():void {
				C_DockDocumentClip_super
				C_FicheSatellite
				F_ui_IdentifierSatellite
				F_ui_FrequenceEtImage
				F_ui_ReglageFrequence
				C_ui_ImageEffect
			}
