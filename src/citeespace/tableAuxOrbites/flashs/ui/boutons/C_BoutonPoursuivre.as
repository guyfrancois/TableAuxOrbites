package citeespace.tableAuxOrbites.flashs.ui.boutons
{
	 ...
	 */
	public class C_BoutonPoursuivre extends CTactileBouton implements I_UserResponse
	{
		...
		public function C_BoutonPoursuivre()
		{
			super();
			if (stage) onAddedToStage(null);
			else addEventListener(Event.ADDED_TO_STAGE, onAddedToStage, false,0,true);
			tapEvent = NavigationEvent.BTN_AUTRE_MISSION_CLICKED;
		
		
		}
		
		protected function onAddedToStage(param0:Object):void
		{
