package citeespace.tableAuxOrbites.flashs.ui
{
	...
	/**
	 * Clases de controle d'un champs texte tf répartir sur 3 frames pour potionnement/stylage selon la langue<br>
	 * 
	 *GUYF<br>
	 * interroge l'utilisateur courant par les evenements de propagation
	 * 
	 * @author Sps
	 ...
	 */
	public class C_ClipUserTxtLocalizable extends MovieClip implements I_UserResponse
	{
		...
		public function C_ClipUserTxtLocalizable()
		{
			super();
			stop();
