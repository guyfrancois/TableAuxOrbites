package citeespace.tableAuxOrbites.flashs.ui_identifierSignal
{
	...
	public class C_ErreurSignalContenu extends MovieClip implements I_UserResponse
	{
		...
		public function C_ErreurSignalContenu()
		{
			super();
		...
		private function _update():void {
			...
			var txtIdT:String = "ui_label_identifier_signal_sat"+GameData.instance.selectedSatellite+'_'+id;
			var daCo:DataCollection = DataCollection.instance;
			
			var strT:String = daCo.getText(txtIdT, _lang);
			...
			this.texte.wordWrap=true;
			
			this.texte.htmlText = strT+"<br/><br/>"+str;
			/*
			if (strIsHtml) 
			{
				this.texte.htmlText = strT+"<br/>"+str;
			} else {
				this.texte.text = str+"\r"+str;
			}
			*/
			...
			fond.height=rect.height+rect.y*2
			//fond.x=rect.x+5
			//fond.y=rect.y+5
